...
> - <p align="justify"><strong>ORIGINAL SOURCES</strong>: Folder containing the original data files downloaded from each source web page referenced. Specifically:</p>
  ...
  >   - <p align="justify"><strong>retirement home_places.csv</strong>: Data files from the open data portal <a href="https://envejecimientoenred.csic.es/datos-abiertos/residencias/">“Envejecimiento en Red”</a>, detailing, for each province, the existing old people’s homes, as well as their number of places and municipal location.</p>
    >     - <p align="justify">retirement home_places_avila.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_burgos.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_leon.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_palencia.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_salamanca.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_segovia.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_soria.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_valladolid.csv</strong>.</p>
    >     - <p align="justify">retirement home_places_zamora.csv</strong>.</p>
